kecepatan = 80;kecepatan2=90;ftganti=0;fungsi=0;ftfungsi=0;fungsiAwal=0;fungsitimer=0;deffotostiker=fotostiker.src;Content.style = "opacity:1;margin-top:30vh;";wallpaper.style="opacity:1";
  audio = new Audio('' + linkmp3.src);

  document.getElementById("loveIn").onclick = function() {if(fungsiAwal==0){audio.play();fungsiAwal=1;loveIn.style="transition:all .20s ease;opacity:0";ket.style="opacity:0";kot.style="opacity:0";setTimeout(mulainama,500)}}
  ...
  function ftmuncul(){
    ...
    fotostiker.style="display:inline-flex;opacity:1;transition:all .20s ease;transform:scale(1);";
  }
  function fthilang(){fotostiker.style="display:inline-flex;opacity:1;transition:all .20s ease;transform:scale(.1)";}
  function jjfoto(){fotostiker.style.animation="rto .20s infinite alternate";setInterval(berjatuhan,200);}
  
  function kethalo(){
  new TypeIt("#halo", {
  strings: ["" + vketikhalo], startDelay: 80, speed: 90, waitUntilVisible: true,
  ...
  setTimeout(akhiran2,500);
  }
  function akhiran2(){
  bq.style="border:0;background:none;box-shadow:none";kalimat.innerHTML="";
  setTimeout(bqmuncul2,400);
  }
  
  //vakhiran=akhiranteks.innerHTML;akhiranteks.innerHTML = "";
  function ketAkhir(){
  new TypeIt("#kalimat", {
  strings: ["" + vakhiran], startDelay: 80, speed: 105, waitUntilVisible: true,
  afterComplete: function(){
    kalimat.innerHTML = vakhiran;
    setTimeout(munculbwh,600);
    setInterval(berjatuhan,600);
  },}).go();
  }
  ...
  function otomatis() {kalbawah.style="position:relative;opacity:0;transform:scale(.3);";setTimeout(anim,500);} 
  function anim() {kalbawah.style="position:relative;opacity:1;transform:scale(1);";}
  
  function bqmuncul(){bq.style = "position:relative;opacity:1;visibility:visible;transform: scale(1);margin-top:15px";setTimeout(mulaiketik1,400);fungsi=1;}
  
  function bqhilang(){bodyblur.style="opacity:.3";bq.style = "position:relative;margin-top:15px;transition:all .20s ease;";kalimat.style="opacity:0;transform:scale(.3);";}
  function bqmuncul2(){bq.style = "position:relative;opacity:1;visibility:visible;transform: scale(1);margin-top:0;border:0;background:none;box-shadow:none;padding:10px 27px;text-align:left";kalimat.style="opacity:1;transform:scale(1);font-size:13px;font-weight:300";setTimeout(ketAkhir,700);}
